...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-0 left-0 z-50" style={{ width: "100vw", maxWidth: "100%" }}>
      {/* TopBar */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-10">
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <a href="/pmb" className="px-3 sm:px-4 py-1 bg-primary text-white text-xs font-semibold hover:bg-primary-light transition-colors">
      ...
      {/* Main Navbar */}
      <div className={`bg-white/95 backdrop-blur-md transition-all duration-500 ${isScrolled ? "shadow-xl py-3" : "py-3"} relative`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center gap-1" ref={dropdownRef}>
                  ...
                  {link.children ? (
                    <>
                      ...
                      <div
                        ...
                        className={`absolute top-full left-0 mt-1 bg-white shadow-2xl border border-gray-100 min-w-[240px] transition-all duration-200 z-50 ${openDropdown === i ? "opacity-100 visible translate-y-0" : "opacity-0 invisible -translate-y-2"}`}
                      >
              ...
              <a href="/pmb" className="ml-4 px-6 py-2.5 bg-primary text-white font-semibold text-sm hover:shadow-lg hover:scale-105 transition-all duration-300">
                Daftar Sekarang
              </a>
            </div>
          ...
          <div className={`lg:hidden overflow-hidden transition-all duration-500 ${isMobileOpen ? "max-h-[600px] mt-4" : "max-h-0"}`}>
            <div className="bg-white shadow-2xl p-4 space-y-1 border">
              ...
              <a href="/pmb" className="block px-4 py-3 bg-primary text-white text-center font-semibold mt-2">
                Daftar Sekarang
              </a>
            </div>
          </div>
