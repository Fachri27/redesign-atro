...
export default function Navbar() {
  ...
  return (
    <div className={`fixed left-0 right-0 z-50 transition-all duration-500 ${isScrolled ? "top-0" : "top-0"}`}>
      {/* TopBar */}
      <div className={`bg-gray-900 text-white text-sm transition-all duration-500 ${isScrolled ? "h-0 overflow-hidden opacity-0" : "h-auto opacity-100"}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-10">
            <div className="flex items-center gap-6">
              <a href="mailto:info@atrodas.ac.id" className="hidden sm:flex items-center gap-2 hover:text-accent transition-colors">
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                info@atrodas.ac.id
              </a>
              <a href="https://wa.me/+6282114989003" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-green-400 transition-colors">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://pmb.atrodas.ac.id/" target="_blank" rel="noopener noreferrer" className="px-4 py-1 bg-primary text-white text-xs font-semibold hover:bg-primary-light transition-colors">
